...
!(function (e, t) {
    ...
    function q() {
        return (
            we || ("undefined" != typeof window && (we = window.gsap) && we.registerPlugin && we)
        );
    }
    function y(e, t) {
            ...
            function Se() {
                ...
                T && (r || n) && T(se, e, t, be, me),
                    ...
                    n &&
                        ...
                        (me[0] = me[1] = me[2] = 0)),
                    (ne || re) &&
                        (Y && Y(se), $ && oe && $(se), re && (h(se), (re = !1)), (ne = oe = !1)),
                    ie && (U(se), (ie = !1)),
                    (ee = 0);
            }
            function Te(e, t, r) {
            ...
            if (!pt || e) {
                ...
                ot && oe.sort(),
                    ...
                    Ot.forEach(function (e) {
                        return (
                            "max" === e.vars.end && e.setPositions(e.start, Fa(e.scroller, e._dir))
                        );
                    }),
            ...
            ((ScrollTrigger.prototype.init = function init(_, T) {
                if (((this.progress = this.start = 0), this.vars && this.kill(!0, !0), gt)) {
                    var k,
                        ...
                        ge =
                            _.horizontal || (_.containerAnimation && !1 !== _.horizontal) ? Re : Ne,
                        he = !re && 0 !== re,
                        ve = I(_.scroller || je),
                    ...
                    if (
                        ...
                        (o =
                            (o =
                                (ne = Se.trigger = I(ne || ie)) && ne._gsap && ne._gsap.stRevert) &&
                            o(Se)),
                        (ie = !0 === ie ? ne : I(ie)),
                        Ha($) &&
                            ($ = {
                    ...
                    (Se.previous = function () {
                        ...
                        (Se.labelToScroll = function (e) {
                            return (
                                (T &&
                                    T.labels &&
                                    (C || Se.refresh() || C) + (T.labels[e] / T.duration()) * z) ||
                                0
                            );
                        }),
    ...
    function lc(e) {
        ...
        if (!a._isScrollT || 2e3 < s - a._isScrollT) {
            ...
            (a._isScroll =
                o && !Ba(o) && o !== n && (se[(t = db(o)).overflowY] || se[t.overflowX])),
                (a._isScrollT = s);
        }
