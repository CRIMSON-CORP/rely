            ...
            ((ScrollSmoother.register = function register(e) {
                return (
                    H ||
                        ...
                        q() &&
                            window.document &&
                            ((F = window), (z = document), (M = z.documentElement), (I = z.body)),
                        B &&
                            ((U = B.utils.toArray),
                            (D = B.utils.clamp),
                            (O = B.parseEase("expo")),
    ...
    function ScrollSmoother(e) {
        ...
        function Ea(t, r, n, o) {
            return function () {
                ...
                return (
                    e || 0 === e || (e = o.getAttribute("data-" + t) || ("speed" === t ? 1 : 0)),
        ...
        A.forEach(function (e) {
            ...
            T && (this.normalizer = L.normalizeScroll(!0 === T ? { debounce: !0, content: n } : T)),
            L.config(e),
            "overscrollBehavior" in F.getComputedStyle(I) &&
                B.set([I, M], { overscrollBehavior: "none" }),
            "scrollBehavior" in F.getComputedStyle(I) && B.set([I, M], { scrollBehavior: "auto" }),
